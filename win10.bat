...
:menu
	...
	echo 
	echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	call :color 0b "	      WELCOME to THY MEAGER WIN10 SCRIPT, created by		"	 
	echo.
	...
	echo "		             \/     \/      \/         \/ 		   "
	echo "		DAVID | IAN | JAMES | VARUN | OWEN | EDWARD		   "
	echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	...
	echo "15)Audit the machine			16)Edit groups (BETA)		   "
	echo "E) Exit				R) Reboot			   "
	echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	set /p answer=Please choose an option for execution of Order 66: 
...
:secOpt
	...
	rem Clear pagefile on shutdown (BETA)
